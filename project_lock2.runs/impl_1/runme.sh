...
HD_PWD='C:/Users/User/Downloads/Atelier7p/project_lock2/project_lock2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalLock_Multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalLock_Multiplier.tcl -notrace
