...
HD_PWD='C:/Users/User/Downloads/Atelier7p/project_lock2/project_lock2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalLock_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DigitalLock_Multiplier.tcl
